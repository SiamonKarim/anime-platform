    ...
    <main className="min-h-screen flex flex-col bg-[#050505]">
      ...
      <nav className="flex justify-between items-center p-6 border-b border-[#222] bg-black/90 sticky top-0 z-50">
        ...
        <form action="/search" method="GET" className="hidden md:flex flex-1 max-w-md mx-8">
          <input type="text" name="q" placeholder="SEARCH..." className="w-full bg-[#111] border border-[#333] text-white px-4 py-1 font-mono text-sm focus:border-[#ff2e00] outline-none transition" />
      ...
      <section className="p-6 md:p-12 max-w-7xl mx-auto w-full">
        ...
        {/* Changed to map over the full array, creating a large grid */}
